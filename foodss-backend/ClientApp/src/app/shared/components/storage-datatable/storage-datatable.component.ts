...
import {DatatablePageContent} from '../../page/content/datatable-page.content';
import {Product} from '../../../product/model/product.model';
import {ColumnDatatable} from '../custom-datatable/model/column.datatable';

@Component({
  selector: 'app-storage-datatable',
  templateUrl: './storage-datatable.component.html',
  styleUrls: ['./storage-datatable.component.scss']
})
