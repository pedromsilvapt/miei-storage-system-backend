...
namespace StorageSystem.Migrations
{
    ...
    [Migration("20190627123238_AddInvitationAuthor")]
    partial class AddInvitationAuthor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StorageSystem.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StorageSystem.Models.ConsumedProductItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ConsumedProductItems");
                });
            ...
            modelBuilder.Entity("StorageSystem.Models.Storage", b =>
                {
                    ...
                    b.Property<DateTime?>("LastWeatherForecast");

                    b.Property<float?>("LastWeatherForecastTemperature");
            ...
            modelBuilder.Entity("StorageSystem.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Pedro M. Silva",
                            Password = "R2Je10yrj7wKg0jz3x/rB/h2AeNNYr0S6w1RYWVm+rU=",
                            Salt = "123",
                            Verified = true
                        },
                        new
            ...
            modelBuilder.Entity("StorageSystem.Models.Storage", b =>
                {
                    b.HasOne("StorageSystem.Models.City", "City")
                        .WithMany()
            ...
            modelBuilder.Entity("StorageSystem.Models.StorageInvitation", b =>
                {
                    b.HasOne("StorageSystem.Models.User", "Author")
